...
package com.sunshinesky.android.widget;
...
class AlbbRoundProgress extends View {
    ...
    public AlbbRoundProgress(Context context) {
        this(context, null);
    }

    public AlbbRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlbbRoundProgress(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.SimpleRoundProgress_srp_roundColor, Color.WHITE);
