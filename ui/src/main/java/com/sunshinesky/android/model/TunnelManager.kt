...
class TunnelManager(private val configStore: ConfigStore) : BaseObservable() {
    ...
    class IntentReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent?) {
            ...
            if ("com.sunshinesky.android.action.REFRESH_TUNNEL_STATES" == action) {
            ...
            state = when (action) {
                "com.sunshinesky.android.action.SET_TUNNEL_UP" -> Tunnel.State.UP
                "com.sunshinesky.android.action.SET_TUNNEL_DOWN" -> Tunnel.State.DOWN
                else -> return
            }
