...
object AlbbAppConfigData {
  ...
  // https://trustsonic.com:8080
   // http://127.0.0.1:8080/swagger-ui.html
    ...
    var albbCustomerInfo: AlbbCustomerObj? = null
        set(value) {
            field = value
        }
    ...
    fun initAuthorization(token:String?, tokenHead:String?) {
        AlbbAppConfigData.tokenHead = tokenHead
        AlbbAppConfigData.token = token
        AlbbAppConfigData.authorization =  tokenHead + token
    }
