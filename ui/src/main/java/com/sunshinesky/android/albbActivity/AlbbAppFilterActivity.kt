...
import com.sunshinesky.android.albbWidget.adapter.AlbbAppFilterAdapter
import com.sunshinesky.android.albbUtils.AlbbLogUtils
import kotlinx.android.synthetic.main.albb_app_filter_activity.*
import org.greenrobot.eventbus.EventBus

class AlbbAppFilterActivity : AlbbBaseActivity() {

    var albbIncludeAlbbAppList:ArrayList<AlbbAppPackageModel> = ArrayList();
    var excludeAlbbAppList:ArrayList<AlbbAppPackageModel> = ArrayList();
    var mListData: ArrayList<AlbbAppPackageModel> = ArrayList()
    var albbAppFilterAdpater:AlbbAppFilterAdapter? = null
...
//    }
    ...
    override fun getLayoutId(): Int {
        return R.layout.albb_app_filter_activity
    }
    ...
    private fun initListener() {
        ...
        cl_add_app.setOnClickListener {
            ...
            var intent = Intent(this,AlbbSelectAppDetailActivity::class.java)
    ...
    fun initView() {
        ...
        val addapter:AlbbAppFilterAdapter =  AlbbAppFilterAdapter(mListData);
        rv_app_channel.setAdapter(addapter);
        albbAppFilterAdpater = addapter
        addapter.onItemClickLister = object : AlbbAppFilterAdapter.OnItemClickLister {
    ...
    fun refreshAdapter(position: Int) {
        ...
        albbAppFilterAdpater?.notifyDataSetChanged()
