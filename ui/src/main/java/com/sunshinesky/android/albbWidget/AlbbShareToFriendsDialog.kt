...
class AlbbShareToFriendsDialog : DialogFragment(){
    ...
    private val content = " Cattle VPN, come with me! https://play.google.com/store/apps/details?id=com.sunshinesky.android"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        immersionBar?.init()
        var rootView = inflater.inflate(R.layout.albb_share_to_friends_dialog, null)
