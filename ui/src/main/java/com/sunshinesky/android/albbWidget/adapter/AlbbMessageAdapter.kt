...
import com.sunshinesky.android.albbData.response.AlbbMessageInfoResonse.MessageObj


class AlbbMessageAdapter (mListDada: ArrayList<MessageObj>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var mList = mListDada
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.albb_message_item, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MessageHolder) {
            ...
            holder.tv_username.text = AlbbAppConfigData.loginName
