...
import com.sunblackhole.android.Application.Companion.get
import com.sunblackhole.android.Application.Companion.getAsyncWorker
import com.sunblackhole.android.Application.Companion.getBackend
import com.sunblackhole.android.Application.Companion.getSharedPreferences
import com.sunblackhole.android.Application.Companion.getTunnelManager
import com.sunblackhole.android.BR
import com.sunblackhole.android.R
import com.sunblackhole.android.backend.Statistics
import com.sunblackhole.android.backend.Tunnel
import com.sunblackhole.android.configStore.ConfigStore
import com.sunblackhole.android.databinding.ObservableSortedKeyedArrayList
...
class TunnelManager(private val configStore: ConfigStore) : BaseObservable() {
    ...
    class IntentReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent?) {
            ...
            if ("com.sunblackhole.android.action.REFRESH_TUNNEL_STATES" == action) {
            ...
            state = when (action) {
                "com.sunblackhole.android.action.SET_TUNNEL_UP" -> Tunnel.State.UP
                "com.sunblackhole.android.action.SET_TUNNEL_DOWN" -> Tunnel.State.DOWN
                else -> return
            }
