...
package com.sunblackhole.android.widget;
...
class AliRoundProgress extends View {
    ...
    public AliRoundProgress(Context context) {
        this(context, null);
    }

    public AliRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AliRoundProgress(Context context, AttributeSet attrs, int defStyle) {
