...
import com.supersunstars.android.DjiInterface.GetUserCallback
...
import kotlinx.android.synthetic.main.dji_login_activity.*
...
class DjiLoginActivity : DjiBaseActivity() , GetUserCallback.IGetUserResponse{
    ...
    override fun getLayoutId(): Int {
        return R.layout.dji_login_activity;
    }
    ...
    private fun facebooksigin() {
        try {
            ...
            val info = packageManager.getPackageInfo(
                    "com.supersunstars.android",  //Insert your own package name.
                    PackageManager.GET_SIGNATURES)
    ...
    private fun initListener() {
        ...
        tv_register.setOnClickListener {
            var intent = Intent(this,DjiRegistActivity::class.java)
            startActivity(intent)
        }
        tv_forget_password.setOnClickListener {
            var intent = Intent(this, DjiForgetPasswordActivity::class.java)
            startActivity(intent)
        }
        ...
        LoginManager.getInstance().registerCallback(callbackManager, object : FacebookCallback<LoginResult?> {
            override fun onSuccess(loginResult: LoginResult?) {
                // App code
                LogUtils.d("DjiLoginActivity login success" + loginResult?.accessToken)
            ...
            override fun onCancel() {
                LogUtils.d("DjiLoginActivity login cancel" )
                // App code
            }
            override fun onError(exception: FacebookException) {

                LogUtils.d("DjiLoginActivity login error" + exception )
