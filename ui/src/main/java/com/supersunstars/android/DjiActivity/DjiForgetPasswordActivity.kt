...
import kotlinx.android.synthetic.main.dji_forget_password_activity.*


class DjiForgetPasswordActivity : DjiBaseActivity() {
    ...
    override fun getLayoutId(): Int {
        return  R.layout.dji_forget_password_activity
    }
    ...
    private fun initTimer(time: Long): CountDownTimer {
        mTimer = object : CountDownTimer(time , 1000) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                btn_get_code.setBackgroundColor(ContextCompat.getColor(this@DjiForgetPasswordActivity,R.color.text_light_black_color))
                btn_get_code.setTextColor(ContextCompat.getColor(this@DjiForgetPasswordActivity,R.color.text_666_color))
            ...
            override fun onFinish() {
                ...
                btn_get_code.setBackgroundColor(ContextCompat.getColor(this@DjiForgetPasswordActivity,R.color.text_blue_color))
                btn_get_code.setTextColor(ContextCompat.getColor(this@DjiForgetPasswordActivity,R.color.white))
