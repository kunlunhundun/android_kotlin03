...
import com.supersunstars.android.Application.Companion.CACHE_EXCCLUDE_DATA
import com.supersunstars.android.Application.Companion.CACHE_INCLUDE_DATA
...
import com.supersunstars.android.DjiWidget.adapter.AppFilterAdapter
import com.supersunstars.android.Djiutils.LogUtils
import kotlinx.android.synthetic.main.dji_app_filter_activity.*
import org.greenrobot.eventbus.EventBus

class DjiAppFilterActivity : DjiBaseActivity() {
...
//    }
    ...
    override fun getLayoutId(): Int {
        return R.layout.dji_app_filter_activity
    }
    ...
    private fun initListener() {
        ...
        cl_add_app.setOnClickListener {
            ...
            var intent = Intent(this,DjiSelectAppDetailActivity::class.java)
