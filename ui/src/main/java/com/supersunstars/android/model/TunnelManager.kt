...
import com.supersunstars.android.Application.Companion.get
import com.supersunstars.android.Application.Companion.getAsyncWorker
import com.supersunstars.android.Application.Companion.getBackend
import com.supersunstars.android.Application.Companion.getSharedPreferences
import com.supersunstars.android.Application.Companion.getTunnelManager
import com.supersunstars.android.BR
import com.supersunstars.android.R
import com.supersunstars.android.backend.Statistics
import com.supersunstars.android.backend.Tunnel
import com.supersunstars.android.configStore.ConfigStore
import com.supersunstars.android.databinding.ObservableSortedKeyedArrayList
...
class TunnelManager(private val configStore: ConfigStore) : BaseObservable() {
    ...
    class IntentReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent?) {
            ...
            if ("com.supersunstars.android.action.REFRESH_TUNNEL_STATES" == action) {
            ...
            state = when (action) {
                "com.supersunstars.android.action.SET_TUNNEL_UP" -> Tunnel.State.UP
                "com.supersunstars.android.action.SET_TUNNEL_DOWN" -> Tunnel.State.DOWN
                else -> return
            }
