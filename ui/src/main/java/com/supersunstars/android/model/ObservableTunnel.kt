...
class ObservableTunnel internal constructor(
    ...
    var onListenCall: OnListenerObservableTunnel? = null


    fun setOnListenerCallBack(onlistenerCallBack: OnListenerObservableTunnel) {
        onListenCall = onlistenerCallBack
    }
    ...
    fun onStateChanged(state: Tunnel.State): Tunnel.State {
        ...
        onListenCall?.onStateChanged(state)
        return state
    }
