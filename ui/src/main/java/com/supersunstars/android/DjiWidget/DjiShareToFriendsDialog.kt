package com.supersunstars.android.DjiWidget
...
class DjiShareToFriendsDialog : DialogFragment(){
    ...
    private val content = " Syrinx VPN, come with me! https://play.google.com/store/apps/details?id=com.supersunstars.android"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        immersionBar?.init()
        var rootView = inflater.inflate(R.layout.dji_share_to_friends_dialog, null)
