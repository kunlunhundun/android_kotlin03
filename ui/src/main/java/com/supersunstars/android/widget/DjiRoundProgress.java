...
package com.supersunstars.android.widget;
...
class DjiRoundProgress extends View {
    ...
    public DjiRoundProgress(Context context) {
        this(context, null);
    }

    public DjiRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DjiRoundProgress(Context context, AttributeSet attrs, int defStyle) {
