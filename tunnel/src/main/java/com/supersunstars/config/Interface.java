...
package com.supersunstars.config;

import com.supersunstars.config.BadConfigException.Location;
import com.supersunstars.config.BadConfigException.Reason;
import com.supersunstars.config.BadConfigException.Section;
import com.supersunstars.crypto.Key;
import com.supersunstars.crypto.KeyFormatException;
import com.supersunstars.crypto.KeyPair;
import com.supersunstars.util.NonNullForAll;
    ...
    private Interface(final Builder builder) {
      ...
      //  excludedApplications = Collections.unmodifiableSet(new LinkedHashSet<>(builder.excludedApplications));
       // includedApplications = Collections.unmodifiableSet(new LinkedHashSet<>(builder.includedApplications));
        excludedApplications = new LinkedHashSet<>(builder.excludedApplications);
        includedApplications = new LinkedHashSet<>(builder.includedApplications);
        keyPair = Objects.requireNonNull(builder.keyPair, "Interfaces must have a private key");
        listenPort = builder.listenPort;
        mtu = builder.mtu;
    }

    public void   setNewExcludedApplications(LinkedHashSet<String> newExcludeApps) {
